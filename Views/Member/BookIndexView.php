...
$homeHref = $isLoggedIn && $isMember ? Url::route('/Views/Member/dashboardView.php') : Url::route('/');
                ...
                <tr>
                    <td>
                        <?php if (isset($book['cover_image_path']) && $book['cover_image_path'] != '') { ?>
                            <img class="cover-thumb" src="/LibraryManagementSystem/<?php echo htmlspecialchars($book['cover_image_path']); ?>" alt="Book Cover">
                        <?php } else { ?>
