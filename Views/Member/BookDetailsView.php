...
$isLoggedIn = $role !== '';
$homeHref = $isLoggedIn && $isMember ? 'BookIndexView.php' : '/LibraryManagementSystem/Controllers/BookIndexController.php';
...
<div class="page-shell">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($a['available_copies'] > 0) { ?>
                                <form method="POST" action="/LibraryManagementSystem/Controllers/BorrowRequestController.php" style="display:inline;"><input type="hidden" name="book_id" value="<?= $book['id'] ?>"><input type="hidden" name="branch_id" value="<?= $a['branch_id'] ?>"><button type="submit" class="btn-link">Borrow Book</button></form>
                            <?php } else { ?>
                                ...
                                <?php else: ?>
                                    <a href="/LibraryManagementSystem/Views/LoginView.php">Login to reserve</a>
                                <?php endif; ?>
                            <?php } ?>
                        </td>
                    </tr>
                ...
                <?php foreach ($reviews as $r) { ?>
                    <div class="review-card">
                        ...
                        <?php if ($isMember && $r['member_id'] == $_SESSION['id']) { ?>
                            <form novalidate action="/LibraryManagementSystem/Controllers/BookReviewController.php" method="POST" style="display:inline; margin-top: 12px;">
    ...
    <?php if ($isMember): ?>
        <div class="section-card">
            ...
            <form class="review-form" novalidate action="/LibraryManagementSystem/Controllers/BookReviewController.php" method="POST" onsubmit="return validateReviewForm(this)">
                <input type="hidden" name="book_id" value="<?= $book['id'] ?>">
