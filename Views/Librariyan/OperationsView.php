...
<table border="1" cellpadding="6" cellspacing="0">
    ...
    <?php foreach ($renewalRequests as $rr) { ?>
        <tr>
            ...
            <td>
                <form novalidate action="../../Controllers/RenewalDecisionController.php" method="POST" style="display:inline;">
...
<script src="../../Views/js/librarian_validation.js"></script>
<script>
...
<script src="../../Views/js/librarian_search.js"></script>
<script src="../../Views/js/librarian_operations.js"></script>
</body>
</html>
