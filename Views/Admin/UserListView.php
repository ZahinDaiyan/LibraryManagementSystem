...
<form novalidate class="search-form" action="../../Controllers/AdminUserController.php" method="POST">
        ...
        <tr>
            ...
            <td>
                <div class="user-actions">
                    <form method="POST" action="../../Controllers/AdminUserFormController.php"><input type="hidden" name="id" value="<?= $u['id'] ?>"><button type="submit" class="btn-link">Edit Info</button></form>
                    <form method="POST" action="../../Controllers/AdminUserActionController.php"><input type="hidden" name="action" value="toggle_status"><input type="hidden" name="id" value="<?= $u['id'] ?>"><button type="submit" onclick="return confirm('Toggle status for this user?')" class="btn-link"><?= $u['is_active'] ? 'Deactivate' : 'Activate' ?></button></form>
                    <?php if ((string)($_SESSION['id'] ?? '') !== (string)$u['id']): ?>
                    <form method="POST" action="../../Controllers/AdminUserActionController.php"><input type="hidden" name="action" value="delete_user"><input type="hidden" name="id" value="<?= $u['id'] ?>"><button type="submit" onclick="return confirm('Delete this user profile?')" class="btn-link-danger">Delete Profile</button></form>
                    <?php endif; ?>
                </div>
            </td>
        </tr>
